...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        ...
        #assert browser.current_url = 'http://selenium1py.pythonanywhere.com/accounts/login/'
        assert 'login' in browser.current_url, "Page addres does not contain text 'login'"
    ...
    def should_be_register_form(self):
        ...
        assert self.is_element_present(*LoginPageLocators.REGISTRATION_EMAIL2), "Registration email2 field is not presented"
